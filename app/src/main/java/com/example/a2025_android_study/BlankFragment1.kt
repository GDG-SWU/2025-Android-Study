...
//5        val action = BlankFragment1Directions.actionBlankFragment1ToBlankFragment2()
//        view.findViewById<Button>(R.id.btn1).setOnClickListener {
//        //4 Navigation.findNavController(view).navigate(R.id.action_blankFragment1_to_blankFragment2)
